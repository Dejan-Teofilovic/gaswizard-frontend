...
export default function Hero() {
  return (
    <>
      {/* Desktop */}
      <div className="hero_bg max-w-screen h-[720px] relative hidden lg:block">
      ...
      {/* Mobile */}
      <div className="hero_mobile_bg py-12 px-6 flex lg:hidden flex-col gap-8">
        ...
        <div>
          ...
          <p className="uppercase text-primary font-semibold text-base">
            XXXXXXXXXXXXXXXXXXXXXXXXXXX
          </p>
        </div>
